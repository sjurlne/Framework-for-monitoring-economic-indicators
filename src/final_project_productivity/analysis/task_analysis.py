import pandas as pd
import pytask
from final_project_productivity.analysis.estimation import for_plotting
from final_project_productivity.analysis.estimation import largest_sectors
from final_project_productivity.analysis.estimation import productivity_table
...
for country in countries:
    ...
    def task_estimate_prod(depends_on, produces, country=country):
        """Creates estimates of productivity, and stores it in suitable tables for
        plotting.
